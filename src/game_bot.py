...
class GameBot:
    ...
    def reset(self):
        pyautogui.moveTo(
            self.convert_x(reset_x), self.convert_y(reset_y), duration=MOUSE_SPEED_FAST
        )
    ...
    def confirm_replace_hand(self):
        pyautogui.moveTo(
            self.convert_x(confirm_replace_hand_x),
            self.convert_y(confirm_replace_hand_y),
            duration=MOUSE_SPEED_FAST,
        )
        pyautogui.click()
    ...
    def play_one_card(self, x):
        y = cards_y
        pyautogui.moveTo(
            self.convert_x(x), self.convert_y(y), duration=MOUSE_SPEED_FAST
        )
        pyautogui.mouseDown()
        pyautogui.moveTo(
            self.convert_x(enemy_face_x),
            self.convert_y(enemy_face_y),
            duration=MOUSE_SPEED_FAST,
        )
        pyautogui.mouseUp()
        ...
        for minnion_x in enemy_minnions_x:
            pyautogui.moveTo(
                self.convert_x(minnion_x),
                self.convert_y(enemy_minnions_y),
                duration=MOUSE_SPEED_FAST,
            )
            pyautogui.click()
        ...
        for minnion_x in player_minnions_x:
            pyautogui.moveTo(
                self.convert_x(minnion_x),
                self.convert_y(player_minnions_y),
                duration=MOUSE_SPEED_FAST,
            )
            pyautogui.click()
    ...
    def play_hero_power(self):
        pyautogui.moveTo(
            self.convert_x(player_hero_power_x),
            self.convert_y(player_hero_power_y),
            duration=MOUSE_SPEED_FAST,
        )
        pyautogui.click()
        ...
        for discover_x in discover3_x:
            pyautogui.moveTo(
                self.convert_x(discover_x),
                self.convert_y(discover3_y),
                duration=MOUSE_SPEED_FAST,
            )
            pyautogui.click()
    ...
    def play_weapon(self):
        pyautogui.moveTo(
            self.convert_x(player_face_x),
            self.convert_y(player_face_y),
            duration=MOUSE_SPEED_FAST,
        )
        pyautogui.click()
        pyautogui.moveTo(
    ...
    def end_turn(self):
        pyautogui.moveTo(
            self.convert_x(end_turn_button_x),
            self.convert_y(end_turn_button_y),
            duration=MOUSE_SPEED_FAST,
        )
        pyautogui.click()
        self.reset()
    ...
    def job_done(self) -> bool:
        height, width = self.window.height, self.window.width
